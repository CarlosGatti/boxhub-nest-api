...
import { DefinedProposalsPublicResolver } from './defined-proposals-public.resolver';
...
@Module({
  imports: [AuthModule],
  providers: [
    DefinedProposalsService,
    DefinedProposalsResolver,
    DefinedProposalsPublicResolver,
    PrismaService,
  ],
