...
import { PublicationCommentUpdateManyWithoutPublicationNestedInput } from '../publication-comment/publication-comment-update-many-without-publication-nested.input';
...
@InputType()
export class PublicationUpdateWithoutCommunityInput {
    ...
    @Field(() => PublicationCommentUpdateManyWithoutPublicationNestedInput, {nullable:true})
    comments?: PublicationCommentUpdateManyWithoutPublicationNestedInput;
