...
import { CommunityMemberUpdateManyWithoutCommunityNestedInput } from '../community-member/community-member-update-many-without-community-nested.input';
...
@InputType()
export class CommunityUpdateWithoutParentCommunityInput {
    ...
    @Field(() => CommunityMemberUpdateManyWithoutCommunityNestedInput, {nullable:true})
