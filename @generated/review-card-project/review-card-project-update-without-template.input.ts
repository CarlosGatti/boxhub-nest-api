...
import { ReviewCardPremiumRequestUpdateManyWithoutProjectNestedInput } from '../review-card-premium-request/review-card-premium-request-update-many-without-project-nested.input';

@InputType()
export class ReviewCardProjectUpdateWithoutTemplateInput {
    ...
    @Field(() => ReviewCardPremiumRequestUpdateManyWithoutProjectNestedInput, {nullable:true})
    premiumRequests?: ReviewCardPremiumRequestUpdateManyWithoutProjectNestedInput;
}
