...
import { UserCreateNestedOneWithoutReviewCardProjectsInput } from '../user/user-create-nested-one-without-review-card-projects.input';
...
@InputType()
export class ReviewCardProjectCreateWithoutPremiumRequestsInput {
    ...
    @Field(() => UserCreateNestedOneWithoutReviewCardProjectsInput, {nullable:false})
    @Type(() => UserCreateNestedOneWithoutReviewCardProjectsInput)
    user!: UserCreateNestedOneWithoutReviewCardProjectsInput;
