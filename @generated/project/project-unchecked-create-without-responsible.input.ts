...
import { PermitInspectionUncheckedCreateNestedManyWithoutProjectInput } from '../permit-inspection/permit-inspection-unchecked-create-nested-many-without-project.input';
...
@InputType()
export class ProjectUncheckedCreateWithoutResponsibleInput {
    ...
    @Field(() => PermitInspectionUncheckedCreateNestedManyWithoutProjectInput, {nullable:true})
    permits?: PermitInspectionUncheckedCreateNestedManyWithoutProjectInput;
