...
@InputType()
export class DefinedAcademyLessonScalarWhereInput {

    @Field(() => [DefinedAcademyLessonScalarWhereInput], {nullable:true})
    AND?: Array<DefinedAcademyLessonScalarWhereInput>;

    @Field(() => [DefinedAcademyLessonScalarWhereInput], {nullable:true})
    OR?: Array<DefinedAcademyLessonScalarWhereInput>;

    @Field(() => [DefinedAcademyLessonScalarWhereInput], {nullable:true})
    NOT?: Array<DefinedAcademyLessonScalarWhereInput>;
