...
import { DefinedAcademyLessonModuleIdSlugCompoundUniqueInput } from './defined-academy-lesson-module-id-slug-compound-unique.input';
...
@InputType()
export class DefinedAcademyLessonWhereUniqueInput {

    @Field(() => Int, {nullable:true})
    id?: number;

    @Field(() => DefinedAcademyLessonModuleIdSlugCompoundUniqueInput, {nullable:true})
    moduleId_slug?: DefinedAcademyLessonModuleIdSlugCompoundUniqueInput;
