...
import { DefinedAcademyLessonProgressUncheckedUpdateManyWithoutLessonNestedInput } from '../defined-academy-lesson-progress/defined-academy-lesson-progress-unchecked-update-many-without-lesson-nested.input';

@InputType()
export class DefinedAcademyLessonUncheckedUpdateWithoutResourcesInput {
    ...
    @Field(() => DefinedAcademyLessonProgressUncheckedUpdateManyWithoutLessonNestedInput, {nullable:true})
    progress?: DefinedAcademyLessonProgressUncheckedUpdateManyWithoutLessonNestedInput;
}
