...
import { DefinedAcademyModuleUpdateOneRequiredWithoutLessonsNestedInput } from '../defined-academy-module/defined-academy-module-update-one-required-without-lessons-nested.input';
import { DefinedAcademyResourceUpdateManyWithoutLessonNestedInput } from '../defined-academy-resource/defined-academy-resource-update-many-without-lesson-nested.input';
import { DefinedAcademyLessonProgressUpdateManyWithoutLessonNestedInput } from '../defined-academy-lesson-progress/defined-academy-lesson-progress-update-many-without-lesson-nested.input';

@InputType()
export class DefinedAcademyLessonUpdateInput {
    ...
    @Field(() => DefinedAcademyModuleUpdateOneRequiredWithoutLessonsNestedInput, {nullable:true})
    module?: DefinedAcademyModuleUpdateOneRequiredWithoutLessonsNestedInput;

    @Field(() => DefinedAcademyResourceUpdateManyWithoutLessonNestedInput, {nullable:true})
    resources?: DefinedAcademyResourceUpdateManyWithoutLessonNestedInput;

    @Field(() => DefinedAcademyLessonProgressUpdateManyWithoutLessonNestedInput, {nullable:true})
    progress?: DefinedAcademyLessonProgressUpdateManyWithoutLessonNestedInput;
}
