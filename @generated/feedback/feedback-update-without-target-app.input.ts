...
import { UserUpdateOneWithoutFeedbacksNestedInput } from '../user/user-update-one-without-feedbacks-nested.input';
import { Type } from 'class-transformer';

@InputType()
export class FeedbackUpdateWithoutTargetAppInput {
    ...
    @Field(() => UserUpdateOneWithoutFeedbacksNestedInput, {nullable:true})
    @Type(() => UserUpdateOneWithoutFeedbacksNestedInput)
