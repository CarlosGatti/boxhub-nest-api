...
import { DefinedAcademyReferralUncheckedCreateNestedManyWithoutPartnerInput } from '../defined-academy-referral/defined-academy-referral-unchecked-create-nested-many-without-partner.input';

@InputType()
export class DefinedAcademyPartnerUncheckedCreateWithoutReferralCampaignsInput {
    ...
    @Field(() => DefinedAcademyReferralUncheckedCreateNestedManyWithoutPartnerInput, {nullable:true})
    referrals?: DefinedAcademyReferralUncheckedCreateNestedManyWithoutPartnerInput;
}
