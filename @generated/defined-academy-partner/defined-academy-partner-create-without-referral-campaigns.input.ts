...
import { DefinedAcademyPartnerCategoryCreateNestedOneWithoutPartnersInput } from '../defined-academy-partner-category/defined-academy-partner-category-create-nested-one-without-partners.input';
...
@InputType()
export class DefinedAcademyPartnerCreateWithoutReferralCampaignsInput {
    ...
    @Field(() => DefinedAcademyPartnerCategoryCreateNestedOneWithoutPartnersInput, {nullable:true})
    category?: DefinedAcademyPartnerCategoryCreateNestedOneWithoutPartnersInput;
