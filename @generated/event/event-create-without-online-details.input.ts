...
import { PublicationCreateNestedManyWithoutEventInput } from '../publication/publication-create-nested-many-without-event.input';

@InputType()
export class EventCreateWithoutOnlineDetailsInput {
    ...
    @Field(() => PublicationCreateNestedManyWithoutEventInput, {nullable:true})
    publications?: PublicationCreateNestedManyWithoutEventInput;
}
