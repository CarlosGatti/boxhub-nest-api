...
import { UserUpdateOneWithoutEventsNestedInput } from '../user/user-update-one-without-events-nested.input';
...
@InputType()
export class EventUpdateWithoutOnlineDetailsInput {
    ...
    @Field(() => UserUpdateOneWithoutEventsNestedInput, {nullable:true})
