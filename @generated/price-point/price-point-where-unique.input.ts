...
import { PricePointAssetIdAsOfCompoundUniqueInput } from './price-point-asset-id-as-of-compound-unique.input';
...
@InputType()
export class PricePointWhereUniqueInput {

    @Field(() => Int, {nullable:true})
    id?: number;

    @Field(() => PricePointAssetIdAsOfCompoundUniqueInput, {nullable:true})
    @Type(() => PricePointAssetIdAsOfCompoundUniqueInput)
    assetId_asOf?: PricePointAssetIdAsOfCompoundUniqueInput;
