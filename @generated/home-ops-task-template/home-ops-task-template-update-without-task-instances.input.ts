...
import { HomeOpsHouseholdUpdateOneRequiredWithoutTemplatesNestedInput } from '../home-ops-household/home-ops-household-update-one-required-without-templates-nested.input';
...
@InputType()
export class HomeOpsTaskTemplateUpdateWithoutTaskInstancesInput {
    ...
    @Field(() => HomeOpsHouseholdUpdateOneRequiredWithoutTemplatesNestedInput, {nullable:true})
    household?: HomeOpsHouseholdUpdateOneRequiredWithoutTemplatesNestedInput;
