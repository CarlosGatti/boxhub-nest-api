...
import { HomeOpsTaskTemplateSlotUncheckedUpdateManyWithoutTemplateNestedInput } from '../home-ops-task-template-slot/home-ops-task-template-slot-unchecked-update-many-without-template-nested.input';
import { HomeOpsTaskInstanceUncheckedUpdateManyWithoutTemplateNestedInput } from '../home-ops-task-instance/home-ops-task-instance-unchecked-update-many-without-template-nested.input';

@InputType()
export class HomeOpsTaskTemplateUncheckedUpdateWithoutHouseholdInput {
    ...
    @Field(() => NullableIntFieldUpdateOperationsInput, {nullable:true})
    fixedAssigneeId?: NullableIntFieldUpdateOperationsInput;
    ...
    @Field(() => HomeOpsTaskTemplateSlotUncheckedUpdateManyWithoutTemplateNestedInput, {nullable:true})
    slots?: HomeOpsTaskTemplateSlotUncheckedUpdateManyWithoutTemplateNestedInput;

    @Field(() => HomeOpsTaskInstanceUncheckedUpdateManyWithoutTemplateNestedInput, {nullable:true})
    taskInstances?: HomeOpsTaskInstanceUncheckedUpdateManyWithoutTemplateNestedInput;
}
