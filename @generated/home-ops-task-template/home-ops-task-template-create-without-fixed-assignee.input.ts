...
import { HomeOpsHouseholdCreateNestedOneWithoutTemplatesInput } from '../home-ops-household/home-ops-household-create-nested-one-without-templates.input';
...
@InputType()
export class HomeOpsTaskTemplateCreateWithoutFixedAssigneeInput {
    ...
    @Field(() => HomeOpsHouseholdCreateNestedOneWithoutTemplatesInput, {nullable:false})
    household!: HomeOpsHouseholdCreateNestedOneWithoutTemplatesInput;
