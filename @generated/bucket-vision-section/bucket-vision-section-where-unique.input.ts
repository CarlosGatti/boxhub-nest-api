...
import { BucketVisionSectionBoardIdTypeCompoundUniqueInput } from './bucket-vision-section-board-id-type-compound-unique.input';
...
@InputType()
export class BucketVisionSectionWhereUniqueInput {

    @Field(() => Int, {nullable:true})
    id?: number;

    @Field(() => BucketVisionSectionBoardIdTypeCompoundUniqueInput, {nullable:true})
    boardId_type?: BucketVisionSectionBoardIdTypeCompoundUniqueInput;
