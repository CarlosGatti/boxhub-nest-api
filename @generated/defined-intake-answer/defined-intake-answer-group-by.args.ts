...
import { DefinedIntakeAnswerOrderByWithAggregationInput } from './defined-intake-answer-order-by-with-aggregation.input';
import { DefinedIntakeAnswerScalarFieldEnum } from './defined-intake-answer-scalar-field.enum';
import { DefinedIntakeAnswerScalarWhereWithAggregatesInput } from './defined-intake-answer-scalar-where-with-aggregates.input';
...
@ArgsType()
export class DefinedIntakeAnswerGroupByArgs {

    @Field(() => DefinedIntakeAnswerWhereInput, {nullable:true})
    @Type(() => DefinedIntakeAnswerWhereInput)
    where?: DefinedIntakeAnswerWhereInput;

    @Field(() => [DefinedIntakeAnswerOrderByWithAggregationInput], {nullable:true})
    orderBy?: Array<DefinedIntakeAnswerOrderByWithAggregationInput>;

    @Field(() => [DefinedIntakeAnswerScalarFieldEnum], {nullable:false})
    by!: Array<keyof typeof DefinedIntakeAnswerScalarFieldEnum>;

    @Field(() => DefinedIntakeAnswerScalarWhereWithAggregatesInput, {nullable:true})
    having?: DefinedIntakeAnswerScalarWhereWithAggregatesInput;
