...
import { DefinedAcademyCourseAcademyIdSlugCompoundUniqueInput } from './defined-academy-course-academy-id-slug-compound-unique.input';
...
@InputType()
export class DefinedAcademyCourseWhereUniqueInput {

    @Field(() => Int, {nullable:true})
    id?: number;

    @Field(() => DefinedAcademyCourseAcademyIdSlugCompoundUniqueInput, {nullable:true})
    academyId_slug?: DefinedAcademyCourseAcademyIdSlugCompoundUniqueInput;
