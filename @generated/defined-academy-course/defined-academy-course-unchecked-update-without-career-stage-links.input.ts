...
@InputType()
export class DefinedAcademyCourseUncheckedUpdateWithoutCareerStageLinksInput {
    ...
    @Field(() => DefinedAcademyModuleUncheckedUpdateManyWithoutCourseNestedInput, {nullable:true})
    modules?: DefinedAcademyModuleUncheckedUpdateManyWithoutCourseNestedInput;
