...
import { DefinedAcademyReferralCampaignAcademyIdCodeCompoundUniqueInput } from './defined-academy-referral-campaign-academy-id-code-compound-unique.input';
...
@InputType()
export class DefinedAcademyReferralCampaignWhereUniqueInput {

    @Field(() => Int, {nullable:true})
    id?: number;

    @Field(() => DefinedAcademyReferralCampaignAcademyIdCodeCompoundUniqueInput, {nullable:true})
    academyId_code?: DefinedAcademyReferralCampaignAcademyIdCodeCompoundUniqueInput;
