...
import { DefinedAcademyCourseUpdateOneWithoutReferralCampaignsNestedInput } from '../defined-academy-course/defined-academy-course-update-one-without-referral-campaigns-nested.input';
...
@InputType()
export class DefinedAcademyReferralCampaignUpdateWithoutShortLinksInput {
    ...
    @Field(() => DefinedAcademyCourseUpdateOneWithoutReferralCampaignsNestedInput, {nullable:true})
    course?: DefinedAcademyCourseUpdateOneWithoutReferralCampaignsNestedInput;
