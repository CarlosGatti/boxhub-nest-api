...
import { FeedProfileUpdateOneRequiredWithoutCollectionsNestedInput } from '../feed-profile/feed-profile-update-one-required-without-collections-nested.input';
import { FeedSourceUpdateManyWithoutCollectionNestedInput } from '../feed-source/feed-source-update-many-without-collection-nested.input';

@InputType()
export class FeedCollectionUpdateInput {
    ...
    @Field(() => FeedProfileUpdateOneRequiredWithoutCollectionsNestedInput, {nullable:true})
    profile?: FeedProfileUpdateOneRequiredWithoutCollectionsNestedInput;

    @Field(() => FeedSourceUpdateManyWithoutCollectionNestedInput, {nullable:true})
    sources?: FeedSourceUpdateManyWithoutCollectionNestedInput;
}
