...
import { FeedSourceUncheckedUpdateManyWithoutCollectionNestedInput } from '../feed-source/feed-source-unchecked-update-many-without-collection-nested.input';

@InputType()
export class FeedCollectionUncheckedUpdateWithoutProfileInput {
    ...
    @Field(() => FeedSourceUncheckedUpdateManyWithoutCollectionNestedInput, {nullable:true})
    sources?: FeedSourceUncheckedUpdateManyWithoutCollectionNestedInput;
}
