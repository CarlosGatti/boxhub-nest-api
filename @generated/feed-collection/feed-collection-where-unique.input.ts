...
import { FeedCollectionProfileIdNameCompoundUniqueInput } from './feed-collection-profile-id-name-compound-unique.input';
...
@InputType()
export class FeedCollectionWhereUniqueInput {

    @Field(() => Int, {nullable:true})
    id?: number;

    @Field(() => FeedCollectionProfileIdNameCompoundUniqueInput, {nullable:true})
    profileId_name?: FeedCollectionProfileIdNameCompoundUniqueInput;
