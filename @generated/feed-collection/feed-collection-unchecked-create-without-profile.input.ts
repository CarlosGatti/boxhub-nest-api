...
import { FeedSourceUncheckedCreateNestedManyWithoutCollectionInput } from '../feed-source/feed-source-unchecked-create-nested-many-without-collection.input';

@InputType()
export class FeedCollectionUncheckedCreateWithoutProfileInput {
    ...
    @Field(() => FeedSourceUncheckedCreateNestedManyWithoutCollectionInput, {nullable:true})
    sources?: FeedSourceUncheckedCreateNestedManyWithoutCollectionInput;
}
