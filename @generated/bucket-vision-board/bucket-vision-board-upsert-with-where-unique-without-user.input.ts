...
@InputType()
export class BucketVisionBoardUpsertWithWhereUniqueWithoutUserInput {
    ...
    update!: BucketVisionBoardUpdateWithoutUserInput;

    @Field(() => BucketVisionBoardCreateWithoutUserInput, {nullable:false})
    @Type(() => BucketVisionBoardCreateWithoutUserInput)
    create!: BucketVisionBoardCreateWithoutUserInput;
}
