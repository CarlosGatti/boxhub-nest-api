...
import { BucketVisionGoalLinkUpdateManyWithoutBoardNestedInput } from '../bucket-vision-goal-link/bucket-vision-goal-link-update-many-without-board-nested.input';
...
@InputType()
export class BucketVisionBoardUpdateWithoutSectionsInput {
    ...
    @Field(() => BucketVisionGoalLinkUpdateManyWithoutBoardNestedInput, {nullable:true})
    goalLinks?: BucketVisionGoalLinkUpdateManyWithoutBoardNestedInput;
