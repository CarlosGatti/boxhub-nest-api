...
import { BucketVisionGoalLinkUncheckedCreateNestedManyWithoutBoardInput } from '../bucket-vision-goal-link/bucket-vision-goal-link-unchecked-create-nested-many-without-board.input';
...
@InputType()
export class BucketVisionBoardUncheckedCreateWithoutSectionsInput {
    ...
    @Field(() => BucketVisionGoalLinkUncheckedCreateNestedManyWithoutBoardInput, {nullable:true})
    goalLinks?: BucketVisionGoalLinkUncheckedCreateNestedManyWithoutBoardInput;
