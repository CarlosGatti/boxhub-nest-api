...
import { DefinedClientCreateNestedOneWithoutProposalsInput } from '../defined-client/defined-client-create-nested-one-without-proposals.input';
...
@InputType()
export class DefinedProposalCreateWithoutPricingOptionsInput {
    ...
    @Field(() => DefinedClientCreateNestedOneWithoutProposalsInput, {nullable:false})
    @Type(() => DefinedClientCreateNestedOneWithoutProposalsInput)
    client!: DefinedClientCreateNestedOneWithoutProposalsInput;
