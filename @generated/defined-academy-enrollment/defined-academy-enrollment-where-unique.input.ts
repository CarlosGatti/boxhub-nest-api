...
import { DefinedAcademyEnrollmentCourseIdUserIdCompoundUniqueInput } from './defined-academy-enrollment-course-id-user-id-compound-unique.input';
...
@InputType()
export class DefinedAcademyEnrollmentWhereUniqueInput {

    @Field(() => Int, {nullable:true})
    id?: number;

    @Field(() => DefinedAcademyEnrollmentCourseIdUserIdCompoundUniqueInput, {nullable:true})
    courseId_userId?: DefinedAcademyEnrollmentCourseIdUserIdCompoundUniqueInput;
