...
import { BucketVisionGoalLinkBoardIdGoalIdCompoundUniqueInput } from './bucket-vision-goal-link-board-id-goal-id-compound-unique.input';
...
@InputType()
export class BucketVisionGoalLinkWhereUniqueInput {

    @Field(() => Int, {nullable:true})
    id?: number;

    @Field(() => BucketVisionGoalLinkBoardIdGoalIdCompoundUniqueInput, {nullable:true})
    boardId_goalId?: BucketVisionGoalLinkBoardIdGoalIdCompoundUniqueInput;
