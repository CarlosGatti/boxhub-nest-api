...
import { DefinedAcademyLessonProgressEnrollmentIdLessonIdCompoundUniqueInput } from './defined-academy-lesson-progress-enrollment-id-lesson-id-compound-unique.input';
...
@InputType()
export class DefinedAcademyLessonProgressWhereUniqueInput {

    @Field(() => Int, {nullable:true})
    id?: number;

    @Field(() => DefinedAcademyLessonProgressEnrollmentIdLessonIdCompoundUniqueInput, {nullable:true})
    enrollmentId_lessonId?: DefinedAcademyLessonProgressEnrollmentIdLessonIdCompoundUniqueInput;
