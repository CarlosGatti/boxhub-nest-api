...
@InputType()
export class FeedItemUpdateWithoutEventsInput {
    ...
    @Field(() => FeedSourceUpdateOneRequiredWithoutItemsNestedInput, {nullable:true})
    source?: FeedSourceUpdateOneRequiredWithoutItemsNestedInput;
