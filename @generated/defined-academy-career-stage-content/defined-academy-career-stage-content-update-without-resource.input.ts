...
import { DefinedAcademyCourseUpdateOneWithoutCareerStageLinksNestedInput } from '../defined-academy-course/defined-academy-course-update-one-without-career-stage-links-nested.input';

@InputType()
export class DefinedAcademyCareerStageContentUpdateWithoutResourceInput {
    ...
    @Field(() => DefinedAcademyCourseUpdateOneWithoutCareerStageLinksNestedInput, {nullable:true})
    course?: DefinedAcademyCourseUpdateOneWithoutCareerStageLinksNestedInput;
}
