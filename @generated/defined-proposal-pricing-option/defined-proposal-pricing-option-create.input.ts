...
import { DefinedProposalCreateNestedOneWithoutPricingOptionsInput } from '../defined-proposal/defined-proposal-create-nested-one-without-pricing-options.input';

@InputType()
export class DefinedProposalPricingOptionCreateInput {
    ...
    @Field(() => DefinedProposalCreateNestedOneWithoutPricingOptionsInput, {nullable:false})
    @Type(() => DefinedProposalCreateNestedOneWithoutPricingOptionsInput)
    proposal!: DefinedProposalCreateNestedOneWithoutPricingOptionsInput;
}
