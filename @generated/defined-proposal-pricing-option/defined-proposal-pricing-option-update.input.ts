...
import { DefinedProposalUpdateOneRequiredWithoutPricingOptionsNestedInput } from '../defined-proposal/defined-proposal-update-one-required-without-pricing-options-nested.input';

@InputType()
export class DefinedProposalPricingOptionUpdateInput {
    ...
    @Field(() => DefinedProposalUpdateOneRequiredWithoutPricingOptionsNestedInput, {nullable:true})
    @Type(() => DefinedProposalUpdateOneRequiredWithoutPricingOptionsNestedInput)
    proposal?: DefinedProposalUpdateOneRequiredWithoutPricingOptionsNestedInput;
}
