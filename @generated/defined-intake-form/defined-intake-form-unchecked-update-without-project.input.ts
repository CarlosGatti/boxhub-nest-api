...
import { DefinedIntakeAnswerUncheckedUpdateManyWithoutIntakeFormNestedInput } from '../defined-intake-answer/defined-intake-answer-unchecked-update-many-without-intake-form-nested.input';

@InputType()
export class DefinedIntakeFormUncheckedUpdateWithoutProjectInput {
    ...
    @Field(() => DefinedIntakeAnswerUncheckedUpdateManyWithoutIntakeFormNestedInput, {nullable:true})
    answers?: DefinedIntakeAnswerUncheckedUpdateManyWithoutIntakeFormNestedInput;
}
