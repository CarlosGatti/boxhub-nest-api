...
import { DefinedIntakeAnswerUncheckedCreateNestedManyWithoutIntakeFormInput } from '../defined-intake-answer/defined-intake-answer-unchecked-create-nested-many-without-intake-form.input';

@InputType()
export class DefinedIntakeFormUncheckedCreateWithoutProjectInput {
    ...
    @Field(() => DefinedIntakeAnswerUncheckedCreateNestedManyWithoutIntakeFormInput, {nullable:true})
    answers?: DefinedIntakeAnswerUncheckedCreateNestedManyWithoutIntakeFormInput;
}
