...
import { NestedEnumDiscartItemConditionWithAggregatesFilter } from './nested-enum-discart-item-condition-with-aggregates-filter.input';
import { NestedIntFilter } from './nested-int-filter.input';
import { NestedEnumDiscartItemConditionFilter } from './nested-enum-discart-item-condition-filter.input';

@InputType()
export class EnumDiscartItemConditionWithAggregatesFilter {
