...
import { NestedEnumPhotoCategoryWithAggregatesFilter } from './nested-enum-photo-category-with-aggregates-filter.input';
import { NestedIntFilter } from './nested-int-filter.input';
import { NestedEnumPhotoCategoryFilter } from './nested-enum-photo-category-filter.input';

@InputType()
export class EnumPhotoCategoryWithAggregatesFilter {
