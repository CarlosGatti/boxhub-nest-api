...
import { NestedEnumCommunityMemberRoleWithAggregatesFilter } from './nested-enum-community-member-role-with-aggregates-filter.input';
import { NestedIntFilter } from './nested-int-filter.input';
import { NestedEnumCommunityMemberRoleFilter } from './nested-enum-community-member-role-filter.input';

@InputType()
export class EnumCommunityMemberRoleWithAggregatesFilter {
