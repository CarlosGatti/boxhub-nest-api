...
import { NestedEnumReviewCardLinkModeWithAggregatesFilter } from './nested-enum-review-card-link-mode-with-aggregates-filter.input';
import { NestedIntFilter } from './nested-int-filter.input';
import { NestedEnumReviewCardLinkModeFilter } from './nested-enum-review-card-link-mode-filter.input';

@InputType()
export class EnumReviewCardLinkModeWithAggregatesFilter {
