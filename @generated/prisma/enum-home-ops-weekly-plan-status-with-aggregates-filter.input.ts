...
import { NestedEnumHomeOpsWeeklyPlanStatusWithAggregatesFilter } from './nested-enum-home-ops-weekly-plan-status-with-aggregates-filter.input';
import { NestedIntFilter } from './nested-int-filter.input';
import { NestedEnumHomeOpsWeeklyPlanStatusFilter } from './nested-enum-home-ops-weekly-plan-status-filter.input';

@InputType()
export class EnumHomeOpsWeeklyPlanStatusWithAggregatesFilter {
