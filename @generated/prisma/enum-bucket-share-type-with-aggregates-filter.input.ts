...
import { NestedEnumBucketShareTypeWithAggregatesFilter } from './nested-enum-bucket-share-type-with-aggregates-filter.input';
import { NestedIntFilter } from './nested-int-filter.input';
import { NestedEnumBucketShareTypeFilter } from './nested-enum-bucket-share-type-filter.input';

@InputType()
export class EnumBucketShareTypeWithAggregatesFilter {
