...
import { NestedEnumEventMemberRoleWithAggregatesFilter } from './nested-enum-event-member-role-with-aggregates-filter.input';
import { NestedIntFilter } from './nested-int-filter.input';
import { NestedEnumEventMemberRoleFilter } from './nested-enum-event-member-role-filter.input';

@InputType()
export class EnumEventMemberRoleWithAggregatesFilter {
