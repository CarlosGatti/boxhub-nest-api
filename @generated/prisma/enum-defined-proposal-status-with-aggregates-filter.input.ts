...
import { NestedEnumDefinedProposalStatusWithAggregatesFilter } from './nested-enum-defined-proposal-status-with-aggregates-filter.input';
import { NestedIntFilter } from './nested-int-filter.input';
import { NestedEnumDefinedProposalStatusFilter } from './nested-enum-defined-proposal-status-filter.input';

@InputType()
export class EnumDefinedProposalStatusWithAggregatesFilter {
