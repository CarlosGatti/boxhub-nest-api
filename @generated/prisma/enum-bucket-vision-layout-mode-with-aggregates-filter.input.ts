...
import { NestedEnumBucketVisionLayoutModeWithAggregatesFilter } from './nested-enum-bucket-vision-layout-mode-with-aggregates-filter.input';
import { NestedIntFilter } from './nested-int-filter.input';
import { NestedEnumBucketVisionLayoutModeFilter } from './nested-enum-bucket-vision-layout-mode-filter.input';

@InputType()
export class EnumBucketVisionLayoutModeWithAggregatesFilter {
