...
import { NestedEnumDefinedLeadCrmSyncStatusWithAggregatesFilter } from './nested-enum-defined-lead-crm-sync-status-with-aggregates-filter.input';
import { NestedIntFilter } from './nested-int-filter.input';
import { NestedEnumDefinedLeadCrmSyncStatusFilter } from './nested-enum-defined-lead-crm-sync-status-filter.input';

@InputType()
export class EnumDefinedLeadCrmSyncStatusWithAggregatesFilter {
