...
import { NestedEnumHomeOpsAssignmentModeWithAggregatesFilter } from './nested-enum-home-ops-assignment-mode-with-aggregates-filter.input';
import { NestedIntFilter } from './nested-int-filter.input';
import { NestedEnumHomeOpsAssignmentModeFilter } from './nested-enum-home-ops-assignment-mode-filter.input';

@InputType()
export class EnumHomeOpsAssignmentModeWithAggregatesFilter {
