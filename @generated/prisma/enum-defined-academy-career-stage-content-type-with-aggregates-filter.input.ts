...
import { NestedEnumDefinedAcademyCareerStageContentTypeWithAggregatesFilter } from './nested-enum-defined-academy-career-stage-content-type-with-aggregates-filter.input';
...
@InputType()
export class EnumDefinedAcademyCareerStageContentTypeWithAggregatesFilter {
