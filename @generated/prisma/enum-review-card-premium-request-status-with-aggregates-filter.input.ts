...
import { NestedEnumReviewCardPremiumRequestStatusWithAggregatesFilter } from './nested-enum-review-card-premium-request-status-with-aggregates-filter.input';
...
@InputType()
export class EnumReviewCardPremiumRequestStatusWithAggregatesFilter {
