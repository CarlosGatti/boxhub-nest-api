...
import { NestedEnumDefinedProposalPricingTypeWithAggregatesFilter } from './nested-enum-defined-proposal-pricing-type-with-aggregates-filter.input';
import { NestedIntFilter } from './nested-int-filter.input';
import { NestedEnumDefinedProposalPricingTypeFilter } from './nested-enum-defined-proposal-pricing-type-filter.input';

@InputType()
export class EnumDefinedProposalPricingTypeWithAggregatesFilter {
