...
import { NestedEnumDefinedAcademyShortLinkStatusWithAggregatesFilter } from './nested-enum-defined-academy-short-link-status-with-aggregates-filter.input';
...
@InputType()
export class EnumDefinedAcademyShortLinkStatusWithAggregatesFilter {
