...
import { NestedEnumDefinedProjectServiceTypeWithAggregatesFilter } from './nested-enum-defined-project-service-type-with-aggregates-filter.input';
import { NestedIntFilter } from './nested-int-filter.input';
import { NestedEnumDefinedProjectServiceTypeFilter } from './nested-enum-defined-project-service-type-filter.input';

@InputType()
export class EnumDefinedProjectServiceTypeWithAggregatesFilter {
