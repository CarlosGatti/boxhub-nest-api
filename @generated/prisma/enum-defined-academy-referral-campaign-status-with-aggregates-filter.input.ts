...
import { NestedEnumDefinedAcademyReferralCampaignStatusWithAggregatesFilter } from './nested-enum-defined-academy-referral-campaign-status-with-aggregates-filter.input';
...
@InputType()
export class EnumDefinedAcademyReferralCampaignStatusWithAggregatesFilter {
