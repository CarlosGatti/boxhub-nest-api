...
import { NestedEnumStorageRoleWithAggregatesFilter } from './nested-enum-storage-role-with-aggregates-filter.input';
import { NestedIntFilter } from './nested-int-filter.input';
import { NestedEnumStorageRoleFilter } from './nested-enum-storage-role-filter.input';

@InputType()
export class EnumStorageRoleWithAggregatesFilter {
