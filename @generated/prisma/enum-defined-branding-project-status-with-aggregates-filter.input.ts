...
import { NestedEnumDefinedBrandingProjectStatusWithAggregatesFilter } from './nested-enum-defined-branding-project-status-with-aggregates-filter.input';
...
@InputType()
export class EnumDefinedBrandingProjectStatusWithAggregatesFilter {
