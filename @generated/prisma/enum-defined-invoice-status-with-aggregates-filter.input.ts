...
import { NestedEnumDefinedInvoiceStatusWithAggregatesFilter } from './nested-enum-defined-invoice-status-with-aggregates-filter.input';
import { NestedIntFilter } from './nested-int-filter.input';
import { NestedEnumDefinedInvoiceStatusFilter } from './nested-enum-defined-invoice-status-filter.input';

@InputType()
export class EnumDefinedInvoiceStatusWithAggregatesFilter {
