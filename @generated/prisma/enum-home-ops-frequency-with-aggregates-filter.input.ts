...
import { NestedEnumHomeOpsFrequencyWithAggregatesFilter } from './nested-enum-home-ops-frequency-with-aggregates-filter.input';
import { NestedIntFilter } from './nested-int-filter.input';
import { NestedEnumHomeOpsFrequencyFilter } from './nested-enum-home-ops-frequency-filter.input';

@InputType()
export class EnumHomeOpsFrequencyWithAggregatesFilter {
