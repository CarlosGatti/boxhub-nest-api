...
import { NestedEnumDefinedAcademyLessonProgressStatusWithAggregatesFilter } from './nested-enum-defined-academy-lesson-progress-status-with-aggregates-filter.input';
...
@InputType()
export class EnumDefinedAcademyLessonProgressStatusWithAggregatesFilter {
