...
import { NestedEnumFeedItemTypeWithAggregatesFilter } from './nested-enum-feed-item-type-with-aggregates-filter.input';
import { NestedIntFilter } from './nested-int-filter.input';
import { NestedEnumFeedItemTypeFilter } from './nested-enum-feed-item-type-filter.input';

@InputType()
export class EnumFeedItemTypeWithAggregatesFilter {
