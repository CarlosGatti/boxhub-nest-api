...
import { NestedEnumBucketVisionItemTypeWithAggregatesFilter } from './nested-enum-bucket-vision-item-type-with-aggregates-filter.input';
import { NestedIntFilter } from './nested-int-filter.input';
import { NestedEnumBucketVisionItemTypeFilter } from './nested-enum-bucket-vision-item-type-filter.input';

@InputType()
export class EnumBucketVisionItemTypeWithAggregatesFilter {
