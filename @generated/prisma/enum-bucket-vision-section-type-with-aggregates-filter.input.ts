...
import { NestedEnumBucketVisionSectionTypeWithAggregatesFilter } from './nested-enum-bucket-vision-section-type-with-aggregates-filter.input';
import { NestedIntFilter } from './nested-int-filter.input';
import { NestedEnumBucketVisionSectionTypeFilter } from './nested-enum-bucket-vision-section-type-filter.input';

@InputType()
export class EnumBucketVisionSectionTypeWithAggregatesFilter {
