...
import { NestedEnumDefinedAcademyResourceTypeWithAggregatesFilter } from './nested-enum-defined-academy-resource-type-with-aggregates-filter.input';
import { NestedIntFilter } from './nested-int-filter.input';
import { NestedEnumDefinedAcademyResourceTypeFilter } from './nested-enum-defined-academy-resource-type-filter.input';

@InputType()
export class EnumDefinedAcademyResourceTypeWithAggregatesFilter {
