...
import { NestedEnumBucketVisionPeriodTypeWithAggregatesFilter } from './nested-enum-bucket-vision-period-type-with-aggregates-filter.input';
import { NestedIntFilter } from './nested-int-filter.input';
import { NestedEnumBucketVisionPeriodTypeFilter } from './nested-enum-bucket-vision-period-type-filter.input';

@InputType()
export class EnumBucketVisionPeriodTypeWithAggregatesFilter {
