...
import { NestedEnumReviewCardExportTypeWithAggregatesFilter } from './nested-enum-review-card-export-type-with-aggregates-filter.input';
import { NestedIntFilter } from './nested-int-filter.input';
import { NestedEnumReviewCardExportTypeFilter } from './nested-enum-review-card-export-type-filter.input';

@InputType()
export class EnumReviewCardExportTypeWithAggregatesFilter {
