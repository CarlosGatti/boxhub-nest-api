...
import { NestedEnumDefinedProposalSectionTypeWithAggregatesFilter } from './nested-enum-defined-proposal-section-type-with-aggregates-filter.input';
import { NestedIntFilter } from './nested-int-filter.input';
import { NestedEnumDefinedProposalSectionTypeFilter } from './nested-enum-defined-proposal-section-type-filter.input';

@InputType()
export class EnumDefinedProposalSectionTypeWithAggregatesFilter {
