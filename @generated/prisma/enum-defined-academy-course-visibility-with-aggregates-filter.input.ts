...
import { NestedEnumDefinedAcademyCourseVisibilityWithAggregatesFilter } from './nested-enum-defined-academy-course-visibility-with-aggregates-filter.input';
...
@InputType()
export class EnumDefinedAcademyCourseVisibilityWithAggregatesFilter {
