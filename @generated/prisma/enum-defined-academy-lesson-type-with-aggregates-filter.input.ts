...
import { NestedEnumDefinedAcademyLessonTypeWithAggregatesFilter } from './nested-enum-defined-academy-lesson-type-with-aggregates-filter.input';
import { NestedIntFilter } from './nested-int-filter.input';
import { NestedEnumDefinedAcademyLessonTypeFilter } from './nested-enum-defined-academy-lesson-type-filter.input';

@InputType()
export class EnumDefinedAcademyLessonTypeWithAggregatesFilter {
