...
import { NestedEnumDefinedAcademyStatusWithAggregatesFilter } from './nested-enum-defined-academy-status-with-aggregates-filter.input';
import { NestedIntFilter } from './nested-int-filter.input';
import { NestedEnumDefinedAcademyStatusFilter } from './nested-enum-defined-academy-status-filter.input';

@InputType()
export class EnumDefinedAcademyStatusWithAggregatesFilter {
