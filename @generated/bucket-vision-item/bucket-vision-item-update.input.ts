...
import { BucketVisionBoardUpdateOneRequiredWithoutItemsNestedInput } from '../bucket-vision-board/bucket-vision-board-update-one-required-without-items-nested.input';

@InputType()
export class BucketVisionItemUpdateInput {
    ...
    @Field(() => BucketVisionBoardUpdateOneRequiredWithoutItemsNestedInput, {nullable:true})
    board?: BucketVisionBoardUpdateOneRequiredWithoutItemsNestedInput;
}
