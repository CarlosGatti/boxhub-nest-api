...
@InputType()
export class BucketGoalUpdateWithoutBucketVisionGoalLinksInput {
    ...
    @Field(() => BucketGoalLogUpdateManyWithoutGoalNestedInput, {nullable:true})
    logs?: BucketGoalLogUpdateManyWithoutGoalNestedInput;
