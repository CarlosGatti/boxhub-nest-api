...
import { DefinedInvoiceItemUpdateManyWithoutInvoiceNestedInput } from '../defined-invoice-item/defined-invoice-item-update-many-without-invoice-nested.input';

@InputType()
export class DefinedInvoiceUpdateWithoutCreatedByInput {
    ...
    @Field(() => DefinedInvoiceItemUpdateManyWithoutInvoiceNestedInput, {nullable:true})
    @Type(() => DefinedInvoiceItemUpdateManyWithoutInvoiceNestedInput)
    items?: DefinedInvoiceItemUpdateManyWithoutInvoiceNestedInput;
}
