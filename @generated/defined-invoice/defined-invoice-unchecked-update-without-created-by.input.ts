...
import { DefinedInvoiceItemUncheckedUpdateManyWithoutInvoiceNestedInput } from '../defined-invoice-item/defined-invoice-item-unchecked-update-many-without-invoice-nested.input';

@InputType()
export class DefinedInvoiceUncheckedUpdateWithoutCreatedByInput {
    ...
    @Field(() => DefinedInvoiceItemUncheckedUpdateManyWithoutInvoiceNestedInput, {nullable:true})
    @Type(() => DefinedInvoiceItemUncheckedUpdateManyWithoutInvoiceNestedInput)
    items?: DefinedInvoiceItemUncheckedUpdateManyWithoutInvoiceNestedInput;
}
