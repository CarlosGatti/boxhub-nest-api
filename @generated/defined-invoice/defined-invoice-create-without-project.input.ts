...
import { UserCreateNestedOneWithoutDefinedInvoicesCreatedInput } from '../user/user-create-nested-one-without-defined-invoices-created.input';
...
@InputType()
export class DefinedInvoiceCreateWithoutProjectInput {
    ...
    @Field(() => UserCreateNestedOneWithoutDefinedInvoicesCreatedInput, {nullable:true})
    @Type(() => UserCreateNestedOneWithoutDefinedInvoicesCreatedInput)
    createdBy?: UserCreateNestedOneWithoutDefinedInvoicesCreatedInput;
