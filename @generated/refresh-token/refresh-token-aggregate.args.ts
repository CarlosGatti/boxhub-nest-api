...
import { RefreshTokenAvgAggregateInput } from './refresh-token-avg-aggregate.input';
import { RefreshTokenSumAggregateInput } from './refresh-token-sum-aggregate.input';
...
export class RefreshTokenAggregateArgs {
    ...
    @Field(() => RefreshTokenAvgAggregateInput, {nullable:true})
    _avg?: RefreshTokenAvgAggregateInput;

    @Field(() => RefreshTokenSumAggregateInput, {nullable:true})
    _sum?: RefreshTokenSumAggregateInput;
