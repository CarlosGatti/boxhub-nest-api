...
import { DefinedAcademyCourseCreateNestedManyWithoutAcademyInput } from '../defined-academy-course/defined-academy-course-create-nested-many-without-academy.input';
...
@InputType()
export class DefinedAcademyCreateWithoutReferralCampaignsInput {
    ...
    @Field(() => DefinedAcademyCourseCreateNestedManyWithoutAcademyInput, {nullable:true})
    courses?: DefinedAcademyCourseCreateNestedManyWithoutAcademyInput;
