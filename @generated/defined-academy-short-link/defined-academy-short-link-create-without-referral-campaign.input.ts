...
import { DefinedAcademyCreateNestedOneWithoutShortLinksInput } from '../defined-academy/defined-academy-create-nested-one-without-short-links.input';
...
@InputType()
export class DefinedAcademyShortLinkCreateWithoutReferralCampaignInput {
    ...
    @Field(() => DefinedAcademyCreateNestedOneWithoutShortLinksInput, {nullable:false})
    academy!: DefinedAcademyCreateNestedOneWithoutShortLinksInput;
