...
import { DefinedAcademyUserCareerStageCompletionProfileIdStageIdCompoundUniqueInput } from './defined-academy-user-career-stage-completion-profile-id-stage-id-compound-unique.input';
...
@InputType()
export class DefinedAcademyUserCareerStageCompletionWhereUniqueInput {

    @Field(() => Int, {nullable:true})
    id?: number;

    @Field(() => DefinedAcademyUserCareerStageCompletionProfileIdStageIdCompoundUniqueInput, {nullable:true})
    profileId_stageId?: DefinedAcademyUserCareerStageCompletionProfileIdStageIdCompoundUniqueInput;
