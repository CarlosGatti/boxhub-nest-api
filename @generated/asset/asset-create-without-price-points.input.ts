...
import { TransactionCreateNestedManyWithoutAssetInput } from '../transaction/transaction-create-nested-many-without-asset.input';

@InputType()
export class AssetCreateWithoutPricePointsInput {
    ...
    @Field(() => TransactionCreateNestedManyWithoutAssetInput, {nullable:true})
    @Type(() => TransactionCreateNestedManyWithoutAssetInput)
