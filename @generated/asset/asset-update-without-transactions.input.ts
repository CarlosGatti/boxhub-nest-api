...
import { HoldingUpdateManyWithoutAssetNestedInput } from '../holding/holding-update-many-without-asset-nested.input';
...
@InputType()
export class AssetUpdateWithoutTransactionsInput {
    ...
    @Field(() => HoldingUpdateManyWithoutAssetNestedInput, {nullable:true})
    @Type(() => HoldingUpdateManyWithoutAssetNestedInput)
