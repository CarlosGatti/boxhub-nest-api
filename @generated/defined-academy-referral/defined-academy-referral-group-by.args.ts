...
import { DefinedAcademyReferralOrderByWithAggregationInput } from './defined-academy-referral-order-by-with-aggregation.input';
import { DefinedAcademyReferralScalarFieldEnum } from './defined-academy-referral-scalar-field.enum';
import { DefinedAcademyReferralScalarWhereWithAggregatesInput } from './defined-academy-referral-scalar-where-with-aggregates.input';
...
@ArgsType()
export class DefinedAcademyReferralGroupByArgs {
    ...
    @Field(() => [DefinedAcademyReferralOrderByWithAggregationInput], {nullable:true})
    orderBy?: Array<DefinedAcademyReferralOrderByWithAggregationInput>;

    @Field(() => [DefinedAcademyReferralScalarFieldEnum], {nullable:false})
    by!: Array<keyof typeof DefinedAcademyReferralScalarFieldEnum>;

    @Field(() => DefinedAcademyReferralScalarWhereWithAggregatesInput, {nullable:true})
    having?: DefinedAcademyReferralScalarWhereWithAggregatesInput;
