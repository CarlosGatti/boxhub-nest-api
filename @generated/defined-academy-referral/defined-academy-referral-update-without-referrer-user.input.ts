...
import { UserUpdateOneWithoutDefinedAcademyReferralsAsReferredNestedInput } from '../user/user-update-one-without-defined-academy-referrals-as-referred-nested.input';
...
@InputType()
export class DefinedAcademyReferralUpdateWithoutReferrerUserInput {
    ...
    @Field(() => UserUpdateOneWithoutDefinedAcademyReferralsAsReferredNestedInput, {nullable:true})
    @Type(() => UserUpdateOneWithoutDefinedAcademyReferralsAsReferredNestedInput)
    referredUser?: UserUpdateOneWithoutDefinedAcademyReferralsAsReferredNestedInput;
