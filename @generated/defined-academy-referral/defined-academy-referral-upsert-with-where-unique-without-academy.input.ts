...
import { DefinedAcademyReferralUpdateWithoutAcademyInput } from './defined-academy-referral-update-without-academy.input';
import { DefinedAcademyReferralCreateWithoutAcademyInput } from './defined-academy-referral-create-without-academy.input';

@InputType()
export class DefinedAcademyReferralUpsertWithWhereUniqueWithoutAcademyInput {
    ...
    @Field(() => DefinedAcademyReferralUpdateWithoutAcademyInput, {nullable:false})
    @Type(() => DefinedAcademyReferralUpdateWithoutAcademyInput)
    update!: DefinedAcademyReferralUpdateWithoutAcademyInput;
