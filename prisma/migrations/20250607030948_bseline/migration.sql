-- CreateEnum
CREATE TYPE "LogAction" AS ENUM ('USER_LOGIN', 'USER_LOGOUT', 'ITEM_CREATED', 'ITEM_UPDATED', 'ITEM_DELETED', 'CONTAINER_CREATED', 'CONTAINER_DELETED', 'BUTTON_CLICKED', 'PAGE_VIEWED', 'SEARCH_USED', 'CUSTOM_ACTION', 'REQUEST_PASSWORD_RESET', 'PASSWORD_RESET', 'USER_REGISTERED', 'USER_PROFILE_UPDATED', 'USER_DELETED', 'STORAGE_CREATED', 'STORAGE_DELETED');
